...
export const findSingleWorkout = createAsyncThunk(
  ...
  async (workoutID) => {
    ...
    try {
      ...
      await AsyncStorage.setItem("currentWorkout", JSON.stringify(response.data));
...
export const exerciseSlice = createSlice({
  name: "fitness",
  initialState: {
    defaultWorkout: AsyncStorage.getItem("defaultWorkout"),
    currentWorkout: AsyncStorage.getItem("currentWorkout"),
    loading: false,
    alert: null,
    completeExercises: [],
  },
